...
Route::get('customer/{id}/invoices/new', 'CustomerController@createInvoice');
Route::post('customer/{id}/invoices/new', 'CustomerController@postInvoice');
...
//Route::get('invoices', 'InvoiceController@showAll');
// Route::get('item/new', 'ItemController@create');
// Route::post('item/new', 'ItemController@postCreate');
// Route::get('item/{id}', 'ItemController@show');
// Route::get('item/{id}/edit', 'ItemController@edit');
