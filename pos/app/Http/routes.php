...
Route::get('customer/{id}/invoices', 'CustomerController@viewInvoices');
Route::get('customer/{id}/invoices/new_invoice', 'InvoiceController@createInvoices');
Route::post('customer/{id}/invoices/new_invoice', 'CustomerController@postInvoices');
...
Route::get('customer/{id}/invoice/new','InvoiceController@create');
Route::get('invoice/new','InvoiceController@create');
Route::post('invoice/new','InvoiceController@postCreate');
Route::get('invoice/{id}','InvoiceController@show');
Route::post('invoice/{id}/addItem','InvoiceController@addItemtoInvoice');
Route::get('invoice/{invoice_id}/deleteItem/{item_id}','InvoiceController@deleteItemFromInvoice');
